...
struct PlantPrimaryButtonStyle: ButtonStyle {
    ...
    func makeBody(configuration: Configuration) -> some View {
        ...
        let primaryBG = Color(uiColor: UIColor(named: "BrandPrimary") ?? .systemGreen)
        ...
        let fg = isEnabled ? Color.white : disabledFG
